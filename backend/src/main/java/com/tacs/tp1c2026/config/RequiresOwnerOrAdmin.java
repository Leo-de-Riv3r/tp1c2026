 ...
 *
 * <p>La verificación la hace {@link OwnerOrAdminInterceptor} comparando el {@code userId} del JWT
 * (seteado por {@link JwtAuthenticationFilter}) contra el valor extraído del path o query (según
 ...
 * no matchea</strong> el user del JWT (y el caller no es ADMIN), el request se rechaza con 403.
 *
 * <p>Bypass: si el rol del JWT es {@code ADMIN}, el acceso siempre se permite.
 *
